...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gray-300 text-accentblue p-4 flex flex-wrap justify-between items-center border-2">
      <div className="flex items-center space-x-2 flex-1 mb-2 md:mb-0">
        ...
        <p className="text-sm">
          ...
          i{" "}
          <Link href={"/pravila-privatnosti"} className="underline">
