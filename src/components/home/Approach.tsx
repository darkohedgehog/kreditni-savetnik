        ...
        <div className="">
          ...
          <div className="container mx-auto px-4 py-16 lg:px-8 lg:py-28 xl:max-w-7xl">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-lg border border-white bg-card-bg-light p-5 shadow-sm transition hover:border-blue-600 md:p-7 xl:p-10 dark:border-gray-800 dark:bg-card-bg-dark dark:shadow-none dark:hover:border-blue-400">
              ...
              <div className="rounded-lg border border-white bg-card-bg-light p-5 shadow-sm transition hover:border-blue-600 sm:col-span-2 md:p-7 lg:col-span-1 xl:p-10 dark:border-gray-800 dark:bg-card-bg-dark dark:shadow-none dark:hover:border-blue-400">
